    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  nachocoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NachoCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NACHO, 0.1 NACHO, 1 NACHO and 10 NACHO -- sort of like the paper money you use every day.</li> \
