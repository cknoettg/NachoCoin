    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NACHO-light"), QVariant("light"));
    ui->theme->addItem(QString("NACHO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NACHO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("NACHO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("NACHO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NACHO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NACHO-traditional"), QVariant("trad"));
