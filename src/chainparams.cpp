 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1554605714, nBits=1e0ffff0, nNonce=824293, vtx=1)
...
{
    const char* pszTimestamp = "2020 Vision Warren calls for end to filibuster in Senate";
    const CScript genesisOutputScript = CScript() << ParseHex("04408aaa6668a4e1050bcd5d5a6ff2e0df5ab93eabec085700595ee6d88f35dddfc60104c0e9e4d90f33a8fa99f08c84bff7cbd93b0c3047228fc8706704ece6ca") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x0000014ff5d91f9bc976156f34d5142c46523ad4bb845e5bb13e3fa7fb535189");
        ...
        consensus.defaultAssumeValid = uint256S("0x0000014ff5d91f9bc976156f34d5142c46523ad4bb845e5bb13e3fa7fb535189"); 
        ...
        genesis = CreateGenesisBlock(1554605714, 824293, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // NachoCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkAddress = "1JPKYpPTYxpGa4D2jjdGEyADyUdLPvfn2x";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x0000014ff5d91f9bc976156f34d5142c46523ad4bb845e5bb13e3fa7fb535189"))
        };

        chainTxData = ChainTxData{
            1554605714, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000006a9ccef5fe3638a51deab53562c50051fd20646600e4d7e2721235b22a");
        consensus.BIP65Height = 0; 
        consensus.BIP66Height = 0; 
        consensus.DIP0001Height = 0;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000006a9ccef5fe3638a51deab53562c50051fd20646600e4d7e2721235b22a"); 
        ...
        genesis = CreateGenesisBlock(1554605719UL, 3059916UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Testnet NachoCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet NachoCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet NachoCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        strSporkAddress = "17WdKwh13jXUFgyLndCKVVuRQBD9MYJgtT";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000006a9ccef5fe3638a51deab53562c50051fd20646600e4d7e2721235b22a"))
        };

        chainTxData = ChainTxData{        
            1554605719, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1554605724, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x280538952b3c273c986dc9cf8e4eebbbc2f82995c7cdac463f7292466b86a75c"));
        assert(genesis.hashMerkleRoot == uint256S("0x818b7339dc6cdb78058dabba0a320efb86f903b25459375da6ee2857785f272e"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("nachocoinevo.org",  "devnet-seed.nachocoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x280538952b3c273c986dc9cf8e4eebbbc2f82995c7cdac463f7292466b86a75c"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 5KCFszJYADjg69pBg9UkFk9UyESSBafmy6WPt9qBAMd4mK5MGnG
        strSporkAddress = "19vrQHBxpkjdJ4FGaBBJgRimA7jesuFKuF";
        ...
        // Regtest NachoCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0);
        // Regtest NachoCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,1);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Regtest NachoCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest NachoCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest NachoCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
