...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  lastpaidtime   - Print the last time a node was paid on the network\n"
                "  lastseen       - Print timestamp of when a masternode was last seen on the network\n"
                "  payee          - Print NachoCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
                "  protocol       - Print protocol of a masternode (can be additionally filtered, exact match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "nachocoin",               "masternode",             &masternode,             true,  {} },
    { "nachocoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "nachocoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "nachocoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "nachocoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "nachocoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
