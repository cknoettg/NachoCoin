...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid nachocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid nachocoin address" in e.error['message'])
