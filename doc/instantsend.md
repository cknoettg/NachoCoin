...
This mechanism has been integrated into Bitcore-Node-NachoCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nachocoinpay/insight-api-nachocoin#web-socket-api](https://github.com/nachocoinpay/insight-api-nachocoin#web-socket-api)
* API: [https://github.com/nachocoinpay/insight-api-nachocoin#instantsend-transactions](https://github.com/nachocoinpay/insight-api-nachocoin#instantsend-transactions)
...
By default, the NachoCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NachoCoin Core daemon:
